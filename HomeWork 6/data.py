...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 19:40:05 2019
...
def import_data(use_classes):
    (train_imagesfull, train_labelsfull), (test_images, test_labels) = mnist.load_data();
    train_images=train_imagesfull[:20000][:][:]
    train_labels=train_labelsfull[:20000]    
